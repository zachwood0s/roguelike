...
{
    [CustomEditor(typeof(CustomForwardRendererData), true)]
    [MovedFrom("UnityEditor.Rendering.LWRP")]
    public class CustomForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent cameraColorFilterLabel = EditorGUIUtility.TrTextContent("Camera Color Filter Mode", "Configure the camera's color texture's filter mode.");
        }
        ...
        SerializedProperty m_CameraColorFilterMode;
        ...
        private void OnEnable()
        {
            ...
            m_CameraColorFilterMode = serializedObject.FindProperty("m_CameraColorFilterMode");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(m_CameraColorFilterMode, Styles.cameraColorFilterLabel, true);
