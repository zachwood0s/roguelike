...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class CustomForwardRendererData : ScriptableRendererData
    {
        ...
        internal class CreateForwardRendererAsset : EndNameEditAction
        {
            ...
            {
                var instance = CreateInstance<CustomForwardRendererData>();
        ...
        [MenuItem("Assets/Create/Rendering/Universal Render Pipeline/Custom Forward Renderer", priority = CoreUtils.assetCreateMenuPriority2)]
        ...
        [SerializeField] FilterMode m_CameraColorFilterMode = FilterMode.Point;


        public FilterMode CameraColorFilterMode => m_CameraColorFilterMode;
