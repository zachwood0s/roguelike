...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class CustomForwardRenderer : ScriptableRenderer
    {
        ...
        {
            private const string k_Name = nameof(CustomForwardRenderer);
        ...
        // Custom fields
        FilterMode m_CameraColorFilterMode;
...
#endif
            // Custom Fields
            m_CameraColorFilterMode = data.CameraColorFilterMode;
        ...
        void CreateCameraRenderTarget(ScriptableRenderContext context, ref RenderTextureDescriptor descriptor, bool createColor, bool createDepth)
        {
            ...
            using (new ProfilingScope(cmd, Profiling.createCameraRenderTarget))
            {
                if (createColor)
                {
                    ...
                    cmd.GetTemporaryRT(m_ActiveCameraColorAttachment.id, colorDescriptor, m_CameraColorFilterMode);
                }
